...
// Here I need to start this script up and start polyfilling
// HTML 5 number input elements initial polyfill
(function() {
  var number = document.querySelectorAll('input[type="number"]');
  for(var i = 0; i < number.length; i++) {
    inputTypeNumberPolyfill.polyfillElement(number[i]);
  }
}());
